...
@NamedQueries({
    ...
    @NamedQuery(name = "Products.findByProizwoditel", query = "SELECT p FROM Products p WHERE p.proizwoditel = :proizwoditel"),
    @NamedQuery(name = "Products.findByKoliczestwo", query = "SELECT p FROM Products p WHERE p.koliczestwo = :koliczestwo")})
public class Products implements Serializable {
    ...
    @Size(max = 200)
    @Column(name = "proizwoditel")
    private String proizwoditel;
    @Size(max = 20)
    @Column(name = "koliczestwo")
